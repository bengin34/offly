...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    badges: {
      ...
      special: "Special",
      tagAdventures: "Tag Achievements",
      firstSteps: "First Steps",
      tripMilestones: "Chapter Milestones",
      placeMilestones: "Milestone Achievements",
      entryMilestones: "Memory Milestones",
      countryMilestones: "Consistency",
      photoMilestones: "Photo Milestones",
      cityMilestones: "Tag Tracking",
      cityListAchievements: "Organization",
  ...
  it: {
    ...
    badges: {
      ...
      special: "Speciale",
      tagAdventures: "Traguardi tag",
      firstSteps: "Primi passi",
      tripMilestones: "Traguardi capitoli",
      placeMilestones: "Obiettivi milestone",
      entryMilestones: "Traguardi dei ricordi",
      countryMilestones: "Coerenza",
      photoMilestones: "Traguardi foto",
      cityMilestones: "Tracciamento dei tag",
      cityListAchievements: "Organizzazione",
  ...
  fr: {
    ...
    badges: {
      ...
      special: "Spécial",
      tagAdventures: "Objectifs des tags",
      firstSteps: "Premiers pas",
      tripMilestones: "Étapes des chapitres",
      placeMilestones: "Objectifs de jalons",
      entryMilestones: "Jalons des souvenirs",
      countryMilestones: "Cohérence",
      photoMilestones: "Étapes des photos",
      cityMilestones: "Suivi des tags",
      cityListAchievements: "Organisation",
  ...
  es: {
    ...
    badges: {
      ...
      special: "Especial",
      tagAdventures: "Objetivos de etiquetas",
      firstSteps: "Primeros pasos",
      tripMilestones: "Hitos de capítulos",
      placeMilestones: "Objetivos de hitos",
      entryMilestones: "Hitos de recuerdos",
      countryMilestones: "Consistencia",
      photoMilestones: "Hitos de fotos",
      cityMilestones: "Seguimiento de etiquetas",
      cityListAchievements: "Organización",
  ...
  tr: {
    ...
    badges: {
      ...
      special: "Özel",
      tagAdventures: "Etiket Hedefleri",
      firstSteps: "İlk Adımlar",
      tripMilestones: "Bölüm Kilometre Taşları",
      placeMilestones: "Kilometre Taşı Başarıları",
      entryMilestones: "Anı Kilometre Taşları",
      countryMilestones: "Tutarlılık",
      photoMilestones: "Fotoğraf Kilometre Taşları",
      cityMilestones: "Etiket Takibi",
      cityListAchievements: "Organizasyon",
